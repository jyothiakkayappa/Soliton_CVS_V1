...
public class TC_CVS_OPERATOR_49 extends BaseClass
{
	@Test
	public void changeWatermarkImage() throws InterruptedException, IOException, FindFailed
	{
		...
		{
			addWatermarkInputControl.clickChangeWatermarkImage();
			String imageFilePath="F:\\Soliton Frameworkdata\\Upload Images\\";
			String inputFilePath="F:\\Soliton Frameworkdata\\Upload Images\\";
			...
			Thread.sleep(3000);
			s1.wait(fileNameInputTextbox,20);
			s1.type(fileNameInputTextbox,inputFilePath +"Desert.jpg");
			s1.click(openButton);
			addWatermarkInputControl.clickchangedWatermarkImageUpload();
		}
