...
public class TC_CVS_OPERATOR_130 extends BaseClass
{
	@Test
	public void deleteUploadedImage() throws InterruptedException, IOException
	{
		...
		userDropDown.clickToSelectImage();
		...
		Thread.sleep(3000);
		userDropDown.clickDeleteSelectImage();
