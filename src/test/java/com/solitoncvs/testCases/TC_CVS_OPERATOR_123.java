...
public class TC_CVS_OPERATOR_123 extends BaseClass
{
	@Test
	public void profileOption() throws InterruptedException, IOException
	{
		...
		WebElement P2 = driver.findElement(By.xpath("//a[contains(text(),'Profile')]"));
