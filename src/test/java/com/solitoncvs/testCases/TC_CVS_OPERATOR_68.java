...
public class TC_CVS_OPERATOR_68 extends BaseClass
{
	@Test
	public void RTMPStreamControl() throws InterruptedException, IOException
	{
...
//		goLiveWInputCtl.addLivewithoutPlaybtn();
		...
		outputStreamControls.clickRTMPStreamControl();
		outputStreamControls.clickCopyRTMPOutputUrl();
