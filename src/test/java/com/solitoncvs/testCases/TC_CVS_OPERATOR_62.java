...
public class TC_CVS_OPERATOR_62 extends BaseClass
{
	@Test
	public void audioMixLeftDrag() throws InterruptedException, IOException
	{
...
//		audioMixInputControl.clickAudioMixPlayBtn();
        ...
        Action action = (Action) move.dragAndDropBy(slider,50,50).build();
        action.perform();
